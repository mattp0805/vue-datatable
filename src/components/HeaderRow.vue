...
<template>
  <tr :class="headerClasses">
    ...
    <HeaderField class="hover:bg-primary" v-for="header  in   headers " :sortable="props.sortOptions.sortable"
      :sorted-by="sortedByField(header)" :sorted-direction="props.sortOptions.direction"
